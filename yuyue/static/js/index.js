...
$(document).ready(function(){
   ...
   // $('#qrcode_div').hide()
    ...
    // $(this).after($(this).attr("id"));
        ...
        if(data.slice(0,8)=="预约信息提交成功"){
        alert(data.slice(0,8));
		yuyue_id = parseInt(data.slice(8), 10);
		//console.log("yuyue::",yuyue_id);
		$('#add_yuyue_div').hide();
		$('#wenjuan_div').show();
        }
        else{
    ...
    $('#alert_cancel').click(function () {
        window.location.href="yuyue_preorder";
